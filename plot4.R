...
png(file="plot4.png") #opening png device
par(mfrow=c(2,2))
plot(data$Global_active_power, xaxt="n", type="l", col="black", ylab="Global Active Power", xlab="")
axis(1, at=my_axis_points, labels=daynames[my_axis_points[1:3]], cex.axis= 1.0)

plot(data$Voltage, xaxt="n", type="l", col="black", ylab="Voltage", xlab="datetime")
axis(1, at=my_axis_points, labels=daynames[my_axis_points[1:3]], cex.axis= 1.0)
...
legend("topright", legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col=c("black","red","blue"), lty=1, lwd=0.7, cex=1.0, bty="n")

plot(data$Global_reactive_power, xaxt="n", type="l", col="black", ylab="Voltage", xlab="datetime")
axis(1, at=my_axis_points, labels=daynames[my_axis_points[1:3]], cex.axis= 1.0)
